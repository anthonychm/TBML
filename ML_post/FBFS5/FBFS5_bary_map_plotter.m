...
[nz_coords, pred_flag_list] = bary_obj.plot_bary_coords(pred_bij, ...
    A_x, A_y, B_x, B_y, C_x, C_y, marker, true); % ✓
[z_coords, zpred_flag_list] = bary_obj.plot_bary_coords(zpred_bij, ...
    A_x, A_y, B_x, B_y, C_x, C_y, z_marker, true); % ✓
[RANS_coords, RANS_flag_list] = bary_obj.plot_bary_coords(RANS_bij, ...
    A_x, A_y, B_x, B_y, C_x, C_y, RANS_marker, true); % ✓
[LES_coords, LES_flag_list] = bary_obj.plot_bary_coords(LES_bij, ...
    A_x, A_y, B_x, B_y, C_x, C_y, LES_marker, true); % ✓
